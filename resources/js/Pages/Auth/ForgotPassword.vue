...
const submit = () => {
    form.post(route('password.email'), {
        ...
        onError: (errors) => {
            if (errors.email) {
                form.errors.email = t('userNotFound');
            }
        }
    });
};
...
<template>
    <div class="min-h-screen flex flex-col justify-center items-center bg-base-100">
        ...
        <div class="w-full p-6 m-auto bg-base-100 rounded-md shadow-md ring-2 ring-gray-800/50 lg:max-w-lg">
            ...
            <h1 class="text-3xl font-semibold text-center text-base-content">{{ t('forgotPassword') }}</h1>
            <p class="text-center text-base-content mt-2">
